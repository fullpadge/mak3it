      ...
      <div class="menu-bottom">
        ...
        <div class="footer-social">
          ...
          <a-tooltip title="Email">
            <a href="mailto:skouik@mak3it.org" target="_blank" rel="noopener noreferrer" class="footer-social-link">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="footer-social-icon" xmlns="http://www.w3.org/2000/svg">
          ...
          <a-tooltip title="Discord">
            <a href="https://discord.com/invite/FjX4kpKD" target="_blank" rel="noopener noreferrer" class="footer-social-link">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="footer-social-icon" xmlns="http://www.w3.org/2000/svg">
          ...
          <a-tooltip title="Documentation">
            <a href="https://github.com/fullpadge/mak3it/" target="_blank" rel="noopener noreferrer" class="footer-social-link">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="footer-social-icon" xmlns="http://www.w3.org/2000/svg">
